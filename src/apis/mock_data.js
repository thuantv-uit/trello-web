...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'ThuanDev MERN Stack Board',
    description: 'Pro MERN stack Course',
    type: 'public', // 'private'
    ownerIds: [], // Những users là Admin của board
    memberIds: [], // Những users là member bình thường của board
    columnOrderIds: ['column-id-02', 'column-id-03', 'column-id-01', 'column-id-04'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            cover: 'https://vnmedia2.monkeyuni.net/upload/web/img/con-meo-tieng-anh-1.jpg',
